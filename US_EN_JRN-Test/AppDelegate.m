...
- (BOOL) application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    PKPresentation* presentation = [PKPresentation presentationWithName:@"US_EN_JRN-Test_P_Presentation"];
    NSAssert(presentation != nil, @"Why is there no presentation named 'US_EN_JRN-Test_P_Presentation'?");
