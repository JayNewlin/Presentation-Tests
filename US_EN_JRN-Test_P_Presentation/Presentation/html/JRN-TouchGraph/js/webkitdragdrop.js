...
var webkit_draggable = function(r, ip)
{
	...
	this.initialize = function(root, instance_props)
	{
		...
		var default_props = {scroll : false, revert : false, handle : this.root, zIndex : 1000, horizontal : true, vertical : true, onStart : webkit_tools.empty, onDrag : webkit_tools.empty, onEnd : webkit_tools.empty};		
